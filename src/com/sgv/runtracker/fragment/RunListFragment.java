...
import com.sgv.runtracker.activity.RunActivity;
import com.sgv.runtracker.database.RunDatabaseHelper.RunCursor;
import com.sgv.runtracker.loader.SQLiteCursorLoader;
...
public class RunListFragment extends ListFragment implements LoaderCallbacks<Cursor> {
    ...
    private static class RunCursorAdapter extends CursorAdapter {
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            Log.d("DEBUG", "calling bindView" + run.getId());

            if (RunManager.get(context).isTrackingRun(run)) {

                Log.d("DEBUG", "calling bindView in specialCASE" + run.getId());
